package cn.isyellowstar.aigou.controller;

import cn.isyeelowstar.aigou.util.AjaxResult;
import cn.isyellowstar.aigou.domain.Employee;
...
public class LoginController {
    ...
    //以后传递对象太都要用json对象{},[],后台通过@RequestBody
